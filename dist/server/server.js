...
import { H3Event, toResponse, deleteCookie as deleteCookie$1, parseCookies, setCookie as setCookie$1 } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BXDz76uw.js");
...
}, "1cb658687d1b8c9f8e9d3cf81d4ea8805f29e8e2850d15eedb26d14b1f07b87c": {
  functionName: "testPrice_createServerFn_handler",
  importer: () => import("./assets/api-server-DGgWoQHL.js")
}, "e44da196012487c25bff7773c9ff6ae16e361129d744e208d7ca1e80d14af995": {
  functionName: "testRange_createServerFn_handler",
  importer: () => import("./assets/api-server-DGgWoQHL.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BhH2ONoj.js");
