...
import { S as SorareCard, c as getPositionLabel, C as Checkbox, f as formatLastUpdate, e as extractLeagues, d as filterAndSortCards, V as ViewToggle, h as COLUMN_WIDTHS_STANDALONE, g as getSortIcon, b as CardsList } from "./checkbox-CQ7xt4HU.js";
...
import { L as LoadingSpinner, S as SiteNav } from "./sorare-api-B0wH0OGg.js";
import { u as useCards } from "./use-cards-G-wi8ZRg.js";
...
function CardsPage() {
  return /* @__PURE__ */ jsx("main", { className: "min-h-screen from-slate-50 to-slate-100 p-4 md:p-8 dark:from-slate-900 dark:to-slate-800", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl", children: /* @__PURE__ */ jsx(CardsDashboard, {}) }) });
}
export {
