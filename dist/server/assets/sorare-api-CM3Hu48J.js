...
import { CreditCard, Layers, Save, RefreshCw, Loader2 } from "lucide-react";
...
function AppPageShell({
  ...
  const variantClasses = {
    default: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 pt-4 md:p-6 md:pt-6 lg:p-8 lg:pt-8 dark:from-slate-900 dark:to-slate-800",
  ...
  return /* @__PURE__ */ jsx("main", { className: cn(variantClasses[variant], className), children });
}
function PageContainer({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn(sizeClasses[size], className), children });
}
...
function PageLayout({
  ...
  return /* @__PURE__ */ jsx(AppPageShell, { variant: shellVariant, children: /* @__PURE__ */ jsx(PageContainer, { size: containerSize, children: /* @__PURE__ */ jsxs(PageContent, { className, children: [
    showNav && /* @__PURE__ */ jsx(SiteNav, {}),
    children
  ] }) }) });
}
const ICON_MAP = {
