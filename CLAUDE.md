...
- **Format code**: `pnpm format` (alias di `pnpm exec ultracite fix`)
...
Never start the dev server autonomously. Always ask the user for confirmation before starting the dev server.
